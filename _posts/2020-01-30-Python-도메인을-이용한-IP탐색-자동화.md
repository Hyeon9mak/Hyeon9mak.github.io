...
DataFrame의 *to_csv*함수를 이용해서 csv파일로 저장한다. 이때 인코딩은 한글 도메인이 섞여있는 경우도 있었으므로 **cp949**로 지정했다. index는 필요없으므로 false, 저장은 write모드로 덮어씌워지도록 했다.


## 결과
![photo3](https://user-images.githubusercontent.com/37354145/73817474-56ca1080-482e-11ea-8312-94de64b15f0f.PNG)
